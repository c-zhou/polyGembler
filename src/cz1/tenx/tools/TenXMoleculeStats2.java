...
public class TenXMoleculeStats2 extends Executor {
				...
				public void run() {
					...
					try {
						...
						for(int i=0; i!=n_bc;i++) {
							if(bc_records.get(i).getReadUnmappedFlag()) {
								bc_records.remove(i);
								--i;
								--n_bc;
							}
	...
	public static void main(String[] args) {
		TenXMoleculeStats2 stats = new TenXMoleculeStats2();
		stats.setParameters(new String[]{
				"-i", "C:\\Users\\chenxi.zhou\\Desktop\\10x_igv\\440132-beauregard-323-1m-bc.bam",
				"-t", "3",
				"-o", "C:\\Users\\chenxi.zhou\\Desktop\\10x_igv\\out.txt"
		});
		stats.run();
		//stats.r();
		stats.hist();
